...
import com.kwonyijun.yjmusicappv2.playlist.PlaylistAdapter;
...
public class AddToPlaylistAdapter extends RecyclerView.Adapter<AddToPlaylistAdapter.ViewHolder> {
    ...
    private AddToPlaylistAdapter.ItemClickListener itemClickListener;
    public AddToPlaylistAdapter(Context context, List<Playlist> playlists) {
    ...
    public AddToPlaylistAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_add_to_playlist, parent, false);
    ...
    public void setItemClickListener(AddToPlaylistAdapter.ItemClickListener itemClickListener) {
